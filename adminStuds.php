                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class='col-sm-10 col-sm-offset-1'>
                            ...
                            <table id = "myTable" class="tablesorter table table-bordered">
                                ...
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        $get = mysqli_query($mysqli, "SELECT * FROM MEMBERSHIP_STATUS WHERE STUDENT_ID = ".$row[0]);
                                        ...
                                        echo 
                                                    ...
                                                    <a href='editStudent.php?eid=".$row[0]."' class='edit'>
                                                    ...
                                                    <a href='deleteStudent.php?eid=".$row[0]."' class='delete'>
                            ...
                            <a href="addStudent.php" class ="btn btn-primary" role="button">Add</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
...
$(document).ready(function() { 
    ...
    $(".delete").on("click",function(){
        return confirm("Are you sure you want to delete this row? (WARNING: ALL THOSE WITH THE SAME ID WILL BE DELETED IN THE OTHER TABLES)");
    });
