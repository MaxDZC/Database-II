<?php
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM OFFICER WHERE student_id = ".$_GET['eid']);
                        ...
                        <div class='col-sm-6 col-sm-offset-1'>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Officer Information</h3>
                                </div>
                            </div>
                            
                            <form name="myForm" method="POST" onsubmit="return validateForm()" action="updateOfficer.php">
                                <input type="text" value="<?php echo $data[0]; ?>" name="student_id" class="form-control" hidden><br>
                                <input type="text" value="<?php echo $data[3]; ?>" name="position" placeholder="Position" class="form-control" ><br>
                                <input type="password" name="Oldpassword" placeholder="Enter Old Password" class="form-control" ><br>
                                <input type="password" name="NewPassword" placeholder="Enter New Password" class="form-control" ><br>
                                <input type="password" name="RetypePassword" placeholder="Retype Password" class="form-control" ><br>
