                    ...
                    <div class="row">
                        <div class='col-sm-12 col-sm-offset-1'>
                            ...
                            <table id = "myTable" class="tablesorter table table-bordered">
                                ...
                                <?php
                                    $result = mysqli_query($mysqli, "SELECT * FROM PAYMENT WHERE description != 'officership'");

                                    while($row = mysqli_fetch_array($result)){
                                        $plz = mysqli_query($mysqli, "SELECT * FROM STUDENT WHERE STUDENT_ID = ".$row[1]);
                                        ...
                                        echo 
                                            "<tr>
                                                ...
                                                <td>
                                                    <a href='editPayments.php?eid=".$row[0]."' class='edit'>
                                                    ...
                                                    <a href='deletePayment.php?eid=".$row[0]."' class='delete'>
                            ...
                            <div id="pager" class="pager" style="top: 687px; position: absolute;">
                                ...
                                <a href="addPayment.php" class ="btn btn-primary" role="button">Add</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
