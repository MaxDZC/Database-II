                        ...
                        <div class='col-sm-10 col-sm-offset-1'>
                    		<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title">View Announcement</h3>
								</div>
								<br>

								<div class="panel-body">
									<span>ID: <?php echo $data[0]; ?></span><br><br>
									<span>Author: <?php echo $data[1]; ?></span><br><br>
									<span>Timestamp: <?php echo $data[2]; ?></span><br><br>
									<span><?php echo "<img src='".$data[4]."'; height='144px' width='144px'><br>"?></span>
									<span>Message: <?php echo $data[3]; ?></span><br><br>
								</div>
							</div>
                        </div>
                    </div>
