                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class='col-sm-6 col-sm-offset-1'>
                            ...
                            <form name="myForm" method="POST" action="insertPayment.php">
                                ...
                                <a><input type="checkbox" onclick="check()" name="memButton" id="memBtn" value="1">Membership Fee</a><br>
                                <input id="check2" type="text" name="description" placeholder="Enter description of payment" class="form-control" required><br>
                                <input type="text" name="payment_amount" placeholder="Amount Paid" class="form-control" required><br>
                                <span>Date of payment</span>
                                <input type="date" name="date_paid" class="form-control" required><br>
                                <input type="text" name="payment_receiver"  placeholder="Receiver of payment" class="form-control" required><br>
