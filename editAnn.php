<?php
    ...
    $result = mysqli_query($mysqli, "SELECT * FROM ANNOUNCEMENT WHERE announcement_id = ".$_GET['eid']);
                        ...
                        <div class='col-sm-6 col-sm-offset-1'>
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Edit Announcements</h3>
                                </div>
                            </div>
                            
                            <form name="myForm" method="POST" action="updateAnn.php" enctype="multipart/form-data">
                                <input type="text" value="<?php echo $data[0]; ?>" name="ann_id" class="form-control" hidden><br>
                                <input rows="8" type="text" value="<?php echo $data[3]; ?>" name="message" placeholder="Message" class="form-control"><br>
                                Current Image:
                                <?php echo "<img src='".$data[4]."'; height='144px' width='144px'>"; ?>
                                <br><br>
                                New Image:
