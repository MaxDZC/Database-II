                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class='col-sm-12 col-sm-offset-1'>
                            ...
                            <table id = "myTable" class="tablesorter table table-bordered">
                                ...
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        $numRecords = mysqli_num_rows($get);

                                        while($numRecords-- > 0) {
                                            $val = mysqli_fetch_array($get);
                                        }

                                        $plz = mysqli_query($mysqli, "SELECT * FROM STUDENT WHERE STUDENT_ID = ".$row[0]);

                                        $name = mysqli_fetch_array($plz);

                                        echo 
                                            "<tr>
                                                <td>".$row[0]."</td>
                                                <td>".$row[1]."</td>
                                                <td>".$name[3].", ".$name[1]." ".$name[2]."</td>
                                                <td>".$row[3]."</td>
                                                <td>".$name[4]."-".$name[5]."</td>";
                                        ...
                                        if(0 === strpos($_SESSION['username'], "admin")) {
                                            echo 
                                                    ...
                                                    <a href='editOfficer.php?eid=".$row[0]."' class='edit'>
                                                    ...
                                                    <a href='deleteOfficer.php?eid=".$row[0]."' class='delete'>
                            ...
                            <?php
                                if(0 === strpos($_SESSION['username'], "admin")) {
                                    echo '<a href="addOfficer.php" class ="btn btn-primary" role="button">Add</a>';
                                }
                            ?>
                        </div>
                    </div>
