                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class='col-sm-6 col-sm-offset-1'>
                            ...
                            <h2>Attendance of <?php echo $_GET['name']; ?></h2>
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                            ...
                                            echo 
                                                "<tr>
                                                    ...
                                                    <td><a href='deleteAttendance.php?id=".$row[0]."&event_id=".$_GET['id']."'><button class='btn btn-danger'>Delete</button></a></td>
                                                </tr>";
                                        }
                                ?>
                                </tbody>
                            ...
                            <a href="addPerson.php?id=<?php echo $_GET['id']; ?>" class ="btn btn-primary" role="button">Add</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
