                ...
                <div class="animated fadeIn">
                    <div class="row">
                        <div class='col-sm-6 col-sm-offset-1'>
                            ...
                            <form name="myForm" method="POST" action="insertEvents.php">
                                <input class="form-control" type="text" placeholder="Title" name ="title" required><br>
                                <input class="form-control" type="text" placeholder="Venue" name = "venue" required><br>
                                <span>Start Time</span>
                                <input class = "form-control" type="datetime-local" placeholder="Date Start" name="dstart" required><br>
                                <start>End Time</start>
                                <input class = "form-control" type="datetime-local" placeholder="Date End" name="estart" required><br>
                                <input class = "form-control" type="text" placeholder="Organizer" name="org" required><br>
                                <input class = "form-control" type="text" placeholder="Description" name="desc" required><br>
                                <input class = "form-control" type="text" placeholder="Audience Target" name="audTarg"><br>
                                <a><input name ="mandat" type="checkbox" value="1">Mandatory</a><br>
