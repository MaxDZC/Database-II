                    ...
                    <div class="row">
                        <div class='col-sm-12 col-sm-offset-1'>
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        echo 
                                            "<tr>
                                                ...
                                                <td>".$row[1]."</td>
                                                <td>".$row[2]."</td>
                                                <td>".date("(h:i A) m/d/Y", strtotime($row[3]))."</td>
                                                <td>".date("(h:i A) m/d/Y", strtotime($row[4]))."</td>
                                                <td>".$row[6]."</td>
                                                <td>
                                                    <a href='viewCES.php?eid=".$row[0]."'>
                                                    ...
                                                    <a href='editCES.php?eid=".$row[0]."' class='edit'>
                                                    ...
                                                    <a href='deleteCES.php?id=".$row[0]."' class='delete'>
                            ...
                            <div id="pager" class="pager" style="top: 687px; position: absolute;">
                                ...
                                <a href="addCES.php" class ="btn btn-primary" role="button">Add</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
...
$(document).ready(function() { 
    ...
    $(".delete").on("click",function(){
        return confirm("Are you sure you want to delete this CES?");
    });
