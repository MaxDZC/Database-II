                        ...
                        <div class='col-sm-10 col-sm-offset-1'>
                    		<div class="panel panel-primary">
								<div class="panel-heading">
									<h3 class="panel-title">CES View</h3>
								</div>
								<br>

								<div class="panel-body">
									<span>CES ID: <?php echo $data[0]; ?></span><br><br>
									...
									<span>Description: <?php echo $data[5]; ?></span><br><br>
									<span>Organizer: <?php echo $data[6]; ?></span><br><br>
									<span>Contact Person: <?php echo $data[7]; ?></span><br><br>
									<span>Phone Number: <?php echo $data[8]; ?></span><br><br>
								</div>
							</div>
                        </div>
                    </div>
