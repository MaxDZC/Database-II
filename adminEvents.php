                    ...
                    <div class="row">
                        <div class='col-sm-12 col-sm-offset-1'>
                            ...
                            <table id = "myTable" class="tablesorter table table-bordered">
                                ...
                                <?php
                                    ...
                                    while($row = mysqli_fetch_array($result)){
                                        ...
                                        echo     "<td>
                                                    <a href='viewEvent.php?eid=".$row[0]."'>
                                                    ...
                                                    <a href='editEvent.php?eid=".$row[0]."' class='edit'>
                                                    ...
                                                    <a href='deleteEvent.php?id=".$row[0]."' class='delete'>
                            ...
                            <div id="pager" class="pager" style="top: 687px; position: absolute;">
                                ...
                                <a href="addEvents.php" class ="btn btn-primary" role="button">Add</a>
                        </div>
                    </div>
                    <!--/.row-->
                </div>
